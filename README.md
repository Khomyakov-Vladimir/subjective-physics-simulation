...
- **Documentation Split**  
  - [Main article (v11.2, PDF)](https://github.com/Khomyakov-Vladimir/subjective-physics-simulation/releases/download/v11.2.4/subjective_physics_simulation_v11.2_main_article.pdf) — consolidated article  
  - [Extended notes (v11.2, PDF)](https://github.com/Khomyakov-Vladimir/subjective-physics-simulation/releases/download/v11.2.4/subjective_physics_simulation_v11.2_extended_notes.pdf) — supplementary material (retrodiction, weak values, EEG analogies, cultural variation)  
  - [Technical core (v11.2.4, PDF)](https://github.com/Khomyakov-Vladimir/subjective-physics-simulation/releases/download/v11.2.4/a-technical-summary-of-subjective-physics-v11.2.4-2025.pdf) — concise 4-page technical core of v11.2, designed for citation, indexing, and quick reference. Contains all key equations and predictions in a self-contained format.  
