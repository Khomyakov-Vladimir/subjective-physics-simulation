...
To install all required dependencies for **all published versions (v1–v9.0)** of the article:
...
All scripts in versions v1–v9.0 are fully reproducible using the following Conda environment:
...
- [Version 9.0 only](https://doi.org/10.5281/zenodo.XXXXXXXX)
