...
To install all required dependencies for **all published versions (v1–v11.2)** of the article:
...
All scripts in versions **v1–v11.2** are fully reproducible using the following Conda environment:
...
- [Version 11.2 only](https://doi.org/10.5281/zenodo.17285600)
