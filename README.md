...
- **v4_discriminability_entropy/** — Version 4 adds adaptive entropy suppression, dynamic threshold modeling, phase transition analysis, and comparative simulations.
