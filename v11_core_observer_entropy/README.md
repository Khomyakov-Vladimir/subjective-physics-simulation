...
These three modules form the **observer entropy minimal model (v11.0 core)**.  
Running them in sequence is sufficient to reproduce the figures used in the main article.

### Extensions (for completeness and archival)
...
These **extensions** are not required to reproduce the article’s minimal model,  
