...
This separation highlights that v11 primarily refactors and stabilizes the **core formalism**, while keeping prior exploratory features available for replication.
...
These three modules constitute the **core workflow of version (v11.0_main_article)**.
...
These **extensions (v11.0_extended_notes)** are not required to reproduce the article’s **minimal model (v11.0_main_article)**,  
